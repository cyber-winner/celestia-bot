...
const PHRASES = [
    "😉 {s} gives a charming little wink!",
    "✨ {s} winks playfully. You know what that means!",
    "🌟 {s} flashes a confident wink at the crowd."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('wink')
        .setDescription('Express yourself! Usage: -wink')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/wink');
