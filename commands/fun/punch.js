...
const PHRASES = [
    "🥊 {s} delivers a devastating uppercut to {t}!",
    "💥 {s} punches {t} so hard they break the sound barrier!",
    "💢 {s} gives {t} a serious beatdown!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('punch')
        .setDescription('Use punch on someone! Usage: -punch @user')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 👊 Punch!')
                )
