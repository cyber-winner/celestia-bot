...
const PHRASES = [
    "🦊 {s} encountered a magical kitsune!",
    "✨ A beautiful kitsune has blessed {s}~",
    "🐾 {s} summoned an elegant kitsune spirit!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('kitsune')
        .setDescription('Express yourself! Usage: -kitsune')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 🦊 Kitsune!')
                )
