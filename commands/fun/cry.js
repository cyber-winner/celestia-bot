...
const PHRASES = [
    "😭 {s} bursts into uncontrollable tears!",
    "💧 {s} is quietly sobbing in the corner...",
    "🥺 {s}'s eyes well up with tears. Who hurt them?!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('cry')
        .setDescription('Express yourself! Usage: -cry')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 😢 Cry!')
                )
