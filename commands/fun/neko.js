...
const PHRASES = [
    "🐱 {s} summoned a cute little neko!",
    "🐾 Here's an adorable neko just for {s}~",
    "✨ Meow! A precious neko has appeared for {s}!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('neko')
        .setDescription('Express yourself! Usage: -neko')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 🐱 Neko!')
                )
