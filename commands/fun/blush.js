...
const PHRASES = [
    "😳 {s}'s face turns completely red! How embarrassing!",
    "🍅 {s} is blushing profusely... so cute!",
    "✨ {s} looks away, trying to hide their bright red blush."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('blush')
        .setDescription('Express yourself! Usage: -blush')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 😳 Blush!')
                )
