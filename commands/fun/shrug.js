...
const PHRASES = [
    "🤷 {s} just shrugs it off. It is what it is~",
    "😶 {s} has absolutely no idea what's going on.",
    "✨ {s} gives a casual shrug. Not my problem!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('shrug')
        .setDescription('Express yourself! Usage: -shrug')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/shrug');
