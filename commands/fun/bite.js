...
const PHRASES = [
    "🦷 {s} sinks their teeth into {t}! CHOMP!",
    "🧛‍♂️ {s} gives {t} a playful little bite.",
    "🍖 {s} got hungry and decided to bite {t}!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('bite')
        .setDescription('Use bite on someone! Usage: -bite @user')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 😬 Bite!')
                )
