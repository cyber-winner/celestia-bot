...
const PHRASES = [
    "🫡 {s} stands at attention and salutes!",
    "🎖️ {s} gives a crisp, honorable salute.",
    "✨ Sir, yes sir! {s} salutes with perfect form."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('salute')
        .setDescription('Express yourself! Usage: -salute')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/salute');
