...
const PHRASES = [
    "😂 {s} is laughing uncontrollably!",
    "🤣 {s} literally fell out of their chair laughing!",
    "✨ {s} chuckles softly at the joke."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('laugh')
        .setDescription('Express yourself! Usage: -laugh')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/laugh');
