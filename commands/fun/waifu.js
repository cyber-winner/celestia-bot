...
const PHRASES = [
    "💖 {s} discovered a beautiful waifu!",
    "✨ Your new waifu has arrived, {s}!",
    "💍 {s} found their perfect waifu!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('waifu')
        .setDescription('Express yourself! Usage: -waifu')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 💖 Waifu!')
                )
