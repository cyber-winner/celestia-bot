...
const PHRASES = [
    "🤦 {s} slaps their forehead. The stupidity is overwhelming.",
    "📉 {s} just lost all hope for humanity. *Facepalm*",
    "😒 {s} can't even look right now. Absolute facepalm."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('facepalm')
        .setDescription('Express yourself! Usage: -facepalm')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/facepalm');
