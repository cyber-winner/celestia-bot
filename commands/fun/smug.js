...
const PHRASES = [
    "😏 {s} looks incredibly smug right now. They know something you don't.",
    "✨ {s} wears an aura of absolute superiority.",
    "😼 {s} gives the smuggest grin imaginable."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('smug')
        .setDescription('Express yourself! Usage: -smug')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 😏 Smug!')
                )
