...
const PHRASES = [
    "👉 {s} pokes {t} right on the cheek! Boop!",
    "✨ {s} repeatedly pokes {t}... Pay attention to me!",
    "🐾 {s} sneaks up and pokes {t} gently!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('poke')
        .setDescription('Use poke on someone! Usage: -poke @user')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/poke');
