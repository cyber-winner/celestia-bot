...
const PHRASES = [
    "🍱 {s} carefully feeds {t} a delicious bite. Say ahh!",
    "🍙 {s} shoves some food directly into {t}'s mouth! Eat up!",
    "✨ {s} treats {t} to a sweet dessert. How lovely!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('feed')
        .setDescription('Use feed on someone! Usage: -feed @user')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 🍔 Feed!')
                )
