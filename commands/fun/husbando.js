...
const PHRASES = [
    "💖 {s} summoned a handsome husbando!",
    "✨ Your new husbando is here, {s}!",
    "💍 {s} found their dream husbando!"
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('husbando')
        .setDescription('Express yourself! Usage: -husbando')
        ...
        try {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 💖 Husbando!')
                )
