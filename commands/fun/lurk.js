...
const PHRASES = [
    "👀 {s} is lurking in the shadows... watching everyone.",
    "🥷 {s} silently slips into the background, observing the chat.",
    "🕵️‍♂️ You feel a shiver down your spine... {s} is lurking nearby."
];
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('lurk')
        .setDescription('Express yourself! Usage: -lurk')
    ...
    async execute(interaction, client, args) {
        ...
        try {
            const res = await axios.get('https://nekos.best/api/v2/lurk');
            const gif = res.data.results[0];

            const container = new ContainerBuilder()
                .setAccentColor(0xff6b8a)
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('# 👀 Lurk!')
                )
